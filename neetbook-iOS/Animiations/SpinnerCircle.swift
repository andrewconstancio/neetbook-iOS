...
//  neetbook-iOS
//
//  Created by Andrew Constancio on 9/3/23.
//
...
struct Spinner: View {
    ...
    var body: some View {
        ZStack {
            ...
            // S3
            SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: Color.appColorGreen)

            // S2
            SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: Color.appColorBuff)

            // S1
            SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: Color.appColorPale)
        }
    ...
    func animateSpinner() {
        ...
        animateSpinner(with: (rotationTime * 3) + 0.0525) {
            self.rotationDegreeS2 += fullRotation
        }

        animateSpinner(with: (rotationTime * 3) + 0.225) {
